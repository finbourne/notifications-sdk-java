...
* token expiry to ensure continued connectivity to lusidNotifications API without the need
...
public class RefreshingTokenProvider {
    ...
    * that manages direct authentication with lusidNotifications.
    *
    * @param httpFinbourneTokenProvider underlying provider that manages explicit authentication calls to lusidNotifications
    */
