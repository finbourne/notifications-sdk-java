...
* token expiry to ensure continued connectivity to notifications API without the need
...
public class RefreshingTokenProvider {
    ...
    * that manages direct authentication with notifications.
    *
    * @param httpFinbourneTokenProvider underlying provider that manages explicit authentication calls to notifications
    */
